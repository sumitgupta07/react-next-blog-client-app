        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-12 text-center'>
              <h1 className='display-4 font-weight-bold'>PROGRAMMING & WEB DEVELOPMENT BLOGS/TUTORIALS</h1>
            </div>
          </div>
        </div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-12 text-center pt-4 pb-5'>
              <p className='lead'>Best programming and web development blogs and tutorials on React Node NextJs and JavaScript</p>
            </div>
          </div>
        </div>
            ...
            <div className='col-md-4'>
              <div className='flip flip-horizontal'>
                ...
                <div className='back text-center'>
                  ...
                  <p className='lead'>The worlds most popular backend development tool for JavaScript Ninjas</p>
                </div>
              </div>
            </div>
