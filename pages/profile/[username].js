...
const UserProfile = ({user, blogs, query}) => {
  const head = () => (
    <Head>
      ...
      <link rel="canonical" href={`${process.env.NEXT_PUBLIC_DOMAIN}/profile/${query.username}`} />
      <meta property="og:title" content={`${user.username}| ${process.env.NEXT_PUBLIC_APP_NAME}`} />
